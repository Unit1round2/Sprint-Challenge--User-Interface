...
It gives you elements meaning. Like when you move to a new home. Instead of 100 boxes, you can tell that this one is for your room, this one is kitchen, this one is for the laundry room.
...
It allows multiple members efficiently and effectively contribute code to the same project.
